...
void main() {
  group('Biometric Removal Test', () {
    testWidgets('Authentication screen loads without biometric options', (WidgetTester tester) async {
    ...
    test('Authentication service has no biometric methods', () {
      ...
      expect(authService.runtimeType.toString(), contains('AuthenticationService'));
