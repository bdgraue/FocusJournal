...
void main() {
  group('BackupService Tests', () {
    ...
    test('mergeJournals with completeOverwrite strategy should replace all data', () {
      final currentData = {
        'entries': [
          {
            'id': '1',
    ...
    test('mergeJournals with addNewOnly strategy should only add new entries', () {
      final currentData = {
        'entries': [
          {
            'id': '1',
    ...
    test('mergeJournals with smartMerge strategy should keep newest versions', () {
      final currentData = {
        'entries': [
          {
            'id': '1',
