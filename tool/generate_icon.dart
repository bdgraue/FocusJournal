...
void main(List<String> args) async {
  ...
  final spine = img.ColorInt32.rgba(
    0xE6,
    0xE6,
    0xE6,
    0xFF,
  ); // subtle gray accent
  final lineLight = img.ColorInt32.rgba(
    0xFF,
    0xFF,
    0xFF,
    0x22,
  ...
  File('assets/app_icon_foreground.png').writeAsBytesSync(img.encodePng(fgImg));
  ...
  File('assets/app_icon_monochrome.png').writeAsBytesSync(img.encodePng(mono));

  stdout.writeln(
    'Generated assets/app_icon.png, assets/app_icon_foreground.png, and assets/app_icon_monochrome.png',
  );
}
