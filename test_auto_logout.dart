...
void main() {
  group('Auto Logout Tests', () {
    testWidgets('Should logout when app goes to background (paused)', (WidgetTester tester) async {
      // Build the app
      ...
      final AuthenticationWrapper authWrapper = tester.widget(authWrapperFinder);
    ...
    testWidgets('Should logout when app becomes inactive', (WidgetTester tester) async {
      // Build the app
      await tester.pumpWidget(const MyApp());
    ...
    testWidgets('Should NOT logout when app is resumed or detached', (WidgetTester tester) async {
      // Build the app
      await tester.pumpWidget(const MyApp());
